...
class DatabaseHandler:
    ...
    def get_feed_ids_from_application_in_master_id(self, master_id, application_name):
        return self.__byteArrayHandler.get_feed_ids_from_application_in_master_id(master_id, application_name)
    ...
    def get_obfuscatedRetrieval_event_data(self, feed_id, seq_no):
        return self.__eventHandler.get_obfuscatedRetrieval_event_data(feed_id, seq_no)

    #TODO: Test functionality
    def get_obfuscatedRetrieval_event_as_cbor(self, feed_id, seq_no):
        return self.__byteArrayHandler.get_obfuscatedRetrieval_event_as_cbor(feed_id, seq_no)

    #TODO: Test functionality
    def get_last_obfuscatedRetrieval_event_from_feed(self, feed_id):
        return self.__eventHandler.get_last_obfuscatedRetrieval_event_from_feed(feed_id)

    def get_all_obfuscatedRetrieval_events_feed_ids(self):
        return self.__eventHandler.get_all_obfuscatedRetrieval_event_feed()
